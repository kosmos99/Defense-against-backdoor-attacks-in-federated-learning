...
class RFA(Defense):
    ...
    the code1 is translated from the TensorFlow implementation:
    ...
    def exec(self, client_models, net_freq, 
        ...
        """
        # so alphas will be the same as the net freq in our code1
...
class SoftHardFiltering(Defense):
    """
    FedGrad by DungNT
    """
    def __init__(self, total_workers, num_workers, num_adv, num_valid = 1, instance="benchmark", use_trustworthy=False, *args, **kwargs):
        ...
        logger.info("Starting performing SoftHardFiltering...")
...
class FLAME(Defense):
    ...
    and the pseudo-code1 provided by the authors at
...
class DeepSight(Defense):
    """
    We re-implement the DeepSight algorithm based on the provided pseudo-code1 and original paperwork
    by Rieger, Phillip et al. “DeepSight: Mitigating Backdoor Attacks in (Fed)erated Learning Through Deep Model Inspection.” ArXiv abs/2201.00763 (2022): n. pag.
